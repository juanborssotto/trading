...
from freqtrade.rpc.api_server.api_schemas import (AvailablePairs, Balances, BlacklistPayload,
                                                  ...
                                                  StrategyResponse, Version,
                                                  WhitelistResponse, CurrentPrice)
...
@router.get('/current_price', response_model=CurrentPrice)
def get_current_price(pair: Optional[str] = None, config=Depends(get_config)):
    from freqtrade.user_data.strategies.Simple import Simple
    simple_strategy = Simple(config)
    pair_result = simple_strategy.dp.ticker(pair)
    pair_info = pair_result["info"]
